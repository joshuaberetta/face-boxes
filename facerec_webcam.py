...
josh_image = face_recognition.load_image_file("images/josh.jpg")
josh_face_encoding = face_recognition.face_encodings(josh_image)[0]

naomi_image = face_recognition.load_image_file("images/naomi.png")
naomi_face_encoding = face_recognition.face_encodings(naomi_image)[0]
